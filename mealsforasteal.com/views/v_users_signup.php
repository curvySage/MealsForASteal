    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            ...
            <div id="form_error_signup">
                <?php if($error == TRUE): ?>
                    <p id="errorsignup">Username exists. Use another username.</p><br>
                <? endif; ?>
            </div>


            <form name="submit" method="POST" action="/users/p_signup" id="signup_form" onsubmit="return(signup_validate())">
                <h2>Register for Meals for a Steal</h2>
                <hr class="colorgraph">
