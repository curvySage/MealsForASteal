  ...
  <div id="content-section">
    ...
    <?php
      $posts_array = mysqli_query($db,
        "SELECT sum(f.vote), r.title, r.user_id, r.created, r.image, r.recipe_id FROM recipes r inner join feedback f on r.recipe_id = f.recipe_id group by r.title, r.user_id, r.created, r.image, r.recipe_id order by sum(f.vote) DESC LIMIT 15;");
